...
"https://i.pinimg.com/564x/85/25/33/852533b08e1010f0a0e37811a5753cd6.jpg" 
    ...
    <body background="img/bg-login2.png">
        ...
        <?php if ($user) { ?>
            <div class="d-flex justify-content-center align-items-center vh-100">
                ...
                <div class="shadow w-350 p-3 text-center">
                    ...
                    <a href="main/index.php"><button type="button" class="btn btn-success" >Menu</button></a><br><br>
                        </nav>
                        <!--<img src="upload/<?= $user['pp'] ?>" class="img-fluid rounded-circle ">-->
                        <img src="upload/<?= $user['pp'] ?>" class="img-fluid  ">
